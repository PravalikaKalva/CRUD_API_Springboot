...
public class PatientController {
	...
	public List<PatientDto> getAllPatients() {
		LOG.info("Property from Properties file " + testProfileCheck);
		...
		patientsList.stream().forEach(
				...
				e -> LOG.info("First Name {} Last Name {} ", e.getFirstName(), e.getLastName()));
	...
	public ResponseEntity<String> updatePatient(@RequestBody PatientDto patientDto) {
		String msg = patientService.updatePatient(patientDto);
